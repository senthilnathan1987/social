...
/*isotope plugin*/
 ...
 $item.children('.element').slimScroll({height:height});
      });
      return columnWidth;
...
/*  grid and list view toggle function*/
$('#gridView').click(function(){
	$('.list-style-layout').fadeOut();
	$('.grid-style-layout').fadeIn();

});
$('#listView').click(function(){
	$('.grid-style-layout').fadeOut();
	$('.list-style-layout').fadeIn();
	$('.list-style-layout').removeClass('hide');
});


$('#aboutView').click(function () {
